    ...
    <>
      ...
      <Wrap>
        <div className="ng-prose ng-text-primary ng-mx-auto">
          <Title>Setup</Title>
          <p>
            Here&apos;s what I&apos;m coding, gaming and watching videos on. Recently updated for a
            better Covid experience in 2020.
          </p>
          <h2>Code</h2>
          <ul>
          ...
          <ul>
            ...
            <li>Creative Sound Blaster X3 Hi-Res 7.1 Discrete External USB DAC and Amplifier</li>
