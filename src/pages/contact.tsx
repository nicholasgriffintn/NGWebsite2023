  ...
  const submitTheMessage = (data, token) => {
    return new Promise((resolve, reject) => {
      fetch('https://forms.nicholasgriffin.dev/submit', {
        ...
        .then((result) => {
          // eslint-disable-next-line no-console
          console.info('Form Success:', result);
    ...
    <>
      ...
      <Wrap>
        <div className="ng-prose ng-text-primary ng-mx-auto">
          ...
          <p>
            I&apos;m looking forward to hearing from you (as long as you&apos;re not a spammer 😅)!
          </p>
          <p>
          ...
          <hr></hr>
          <small>
            Fancy sending me a text? Try out my automated service here (you can even try sending me
            a fax if that still works...): <a href="tel:+447380327714">+44 7380 327714</a>.
          </small>
          <hr></hr>
          {formSuccess ? (
            <>
              ...
              >
                {thanksImage ? <ResponsiveImage src={thanksImage} alt="Thanks" /> : null}
              </div>
              <h3>Thanks for getting in touch!</h3>
              <p>
                If your message isn&apos;t SPAM and requires a response, I will get back to you
                soon!
              </p>
            </>
          ) : (
            <>
              {formError ? <p>An error occured while attempting to submit the message.</p> : null}
              <form
              ...
              >
                ...
                <div>
                  ...
                  />
                  {errors.subject && <span role="alert">This field is required</span>}
                </div>
                <div>
                  <fieldset>
                    <legend>How would you like to send a message? (Required)</legend>
                    <div>
                      <input
                        type="radio"
                        id="text"
                ...
                {messageType === 'text' ? (
                  ...
                  <div>
                    ...
                    <br></br>
                    <small>
                      Allowed file extensions are: pdf,doc,txt,jpg,jpeg,docx,png,mp3,mp4
                    </small>
                    <br></br>
                    <small>The max file size allowed is: 25MB</small>
                    {errors.uploaded_message && <span role="alert">This field is required</span>}
                  </div>
                ) : null}
                <div>
                  <input placeholder="Anything else?" name="honey" hidden {...register('honey')} />
                </div>
                ...
                <div style={{ marginTop: '15px' }}>
                  ...
                  <button
                    disabled={!token || !messageType || isSubmitting || formSubmitting}
